...
export const handler = async (event) => {
  ...
  try {
    ...
    const users = await sql`SELECT id, role, name, email, contact_number, whatsapp_number, subscription_tier, is_verified_landlord, password_hash FROM users WHERE email = ${email}`;
